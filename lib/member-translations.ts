...
const englishMemberCopyByKey: Record<string, string> = {
  ...
  editNote: "Member ID is locked so your direct signup link stays consistent.",
  ...
  memberId: "Member ID",
  memberIdWarning: "Make sure your Member ID is correct. Member ID cannot be changed after registration.",
