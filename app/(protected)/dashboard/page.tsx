    ...
    translateSimpleMemberCopy(
      {
        ...
        landingPageVisits: "Kunjungan landingpage",
        lifetime: "Lifetime",
        months: "bulan",
        ...
        statsBody: "Ringkasan kunjungan landing page dan panduan yang bisa Anda akses saat ini.",
  ...
  const statCards: MemberStatCard[] = [
    {
      ...
      icon: Users,
      label: copy.landingPageVisits,
      value: String(stats.landingPageVisitCount),
    },
    {
